            ...
            <form action="{{route('case.update', $lawyerCase)}}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <x-input-text name="qcount" value="{{$lawyerCase['qcount'] ?? ''}}" title="صفه الخصم"></x-input-text>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <x-input-text name="qcount1" value="{{$lawyerCase['qcount1'] ?? ''}}" title="صفه الخصم"></x-input-text>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <x-input-text name="qcount2" value="{{$lawyerCase['qcount2'] ?? ''}}" title="صفه الخصم"></x-input-text>

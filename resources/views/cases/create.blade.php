            ...
            <form action="{{route('case.store')}}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <x-input-text name="qcount" value="{{old('qcount')}}" title="صفه الخصم"></x-input-text>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <x-input-text name="qcount1" value="{{old('qcount1')}}" title="صفه الخصم"></x-input-text>
                ...
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <x-input-text name="qcount2" value="{{old('qcount2')}}" title="صفه الخصم"></x-input-text>
